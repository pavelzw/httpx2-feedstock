...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/httpx2-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/httpx2-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `httpx2` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating httpx2-feedstock
=========================

If you would like to improve the httpx2 recipe or build a new
...
Note that all branches in the conda-forge/httpx2-feedstock are
